...
Route::get('/hotels/rooms', [App\Http\Controllers\HomeController::class, 'roomsview'])->name('hotels.rooms-view');
...
//hotels
    ...
    Route::get('/rooms/{id}', [App\Http\Controllers\hotels\HotelController::class, 'rooms'])->name('hotels.rooms');
    Route::get('/rooms-details/{id}', [App\Http\Controllers\hotels\HotelController::class, 'roomDetails'])->name('hotels.rooms.details');
    Route::post('/rooms-booking/{id}', [App\Http\Controllers\hotels\HotelController::class, 'roomBooking'])->name('hotels.rooms.booking');

//pay
    Route::get('/pay', [App\Http\Controllers\hotels\HotelController::class, 'paywithPaypal'])->name('hotels.pay')->middleware('check.for.price');
    Route::get('/success', [App\Http\Controllers\hotels\HotelController::class, 'success'])->name('hotels.success')->middleware('check.for.price');
