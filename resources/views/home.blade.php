...
<div class="hero-wrap js-fullheight" style="margin-top: -50px;  background-image: url('{{ asset('assets') }}/images/image_2.jpg');" data-stellar-background-ratio="0.5">
    ...
    @foreach($rooms as $room)
        <div class="col-lg-6">
            <div class="room-wrap d-md-flex">
                <a href="{{ route('hotels.rooms.details', $room->id) }}" class="img" style="background-image: url({{ asset('assets/images/'.$room->image.'') }});"></a>
                <div class="half left-arrow d-flex align-items-center">
                    <div class="text p-4 p-xl-5 text-center">
                        ...
                        <h3 class="mb-3"><a href="{{ route('hotels.rooms.details', $room->id) }}">{{ $room->name }}</a></h3>
                        ...
                        <p class="pt-1"><a href="{{ route('hotels.rooms.details', $room->id) }}" class="btn-custom px-3 py-2">View Room Details <span class="icon-long-arrow-right"></span></a></p>
                    </div>
                </div>
            </div>
        </div>
