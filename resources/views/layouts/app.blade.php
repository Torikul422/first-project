                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="ftco-nav">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item"><a href="{{ route('hotels.rooms-view') }}" class="nav-link">Apartment Room</a></li>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 col-lg-8">
                            ...
                            Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="#" target="_blank">Md Torikul Islam</a></p>
                        </div>
